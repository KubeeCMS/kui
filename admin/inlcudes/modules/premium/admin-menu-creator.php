...
class Admin_2020_module_admin_menu_creator
{
    ...
    public function start()
    {
		...
		add_action('network_admin_menu', array( $this, 'add_menu_item_network'));
	...
	*/
	...
	public function add_menu_item_network(){
		...
		add_submenu_page(
			...
			__('Menu Creator','admin2020'), // Text to be displayed in the menu.
			'manage_options', // Capability
			'admin-2020-menu-creator', // Page slug, will be displayed in URL
			array($this,'admin2020_menu_creator_app')  // Callback function which displays the page
		);
	...
	public function build_menu_area(){
		...
		<draggable 
		  ...
		  <template #item="{element, index, parentindex = index}">
			...
			<span style="display:block;">
				...
				<div  v-if="element.type == 'sep'" class=" uipress-seperator" :class="element.userClasses">
				...
				<div v-if="element.expand" class="sub_menu_drag">
					...
					<draggable 
					  ...
					  <template #item="{element, index, parentPlace = parentindex}" >
						  ...
						  style="padding:5px;margin-bottom:5px" :class="element.userClasses">
		...
		<div id="edit-menu-item" uk-offcanvas="flip: true; overlay: true">
			<div class="uk-offcanvas-bar">
				...
				<form class="uk-form uk-form-stacked">
					<div class="uk-margin">
						<label class="uk-form-label uk-margin-small-bottom uk-text-bold" for="form-stacked-text"><?php _e('Name','admin2020')?></label>
						<input class="uk-input" v-model="user.currentItem.name" type="text" placeholder="<?php _e('Name','admin2020')?>">
					</div>
					
					<div class="uk-margin" v-if="user.currentItem.type != 'sep'">
						<label class="uk-form-label uk-margin-small-bottom uk-text-bold" for="form-stacked-text"><?php _e('Link','admin2020')?></label>
						<input class="uk-input" v-model="user.currentItem.href" type="text" placeholder="<?php _e('Link','admin2020')?>">
					</div>
					
					<div class="uk-margin">
						<label class="uk-form-label uk-margin-small-bottom uk-text-bold" for="form-stacked-text"><?php _e('Classes','admin2020')?></label>
						<input class="uk-input" v-model="user.currentItem.userClasses" type="text" placeholder="<?php _e('Custom classes','admin2020')?>">
					</div>
					
					<div class="uk-margin">
						<label class="uk-form-label uk-margin-small-bottom uk-text-bold" for="form-stacked-text"><?php _e('Opens in new tab?','admin2020')?></label>
						<label class="admin2020_switch ">
					...
					<div class="uk-margin" v-if="user.currentItem.type != 'sep'">
						<label class="uk-form-label uk-margin-small-bottom uk-text-bold" for="form-stacked-text"><?php _e('Icon','admin2020')?></label>
