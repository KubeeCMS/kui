...
uipressOverviewApp.component("date-range-picker", {
  ...
  template:
    '<div class="uk-flex uk-flex uk-flex-center uk-flex-middle uip-date-range-container">\
      <span @click="showPicker()" class="material-icons-outlined  uk-text-muted" style="margin-right:5px;">date_range</span>\
      <input class="uk-input uk-form-small" type="text" id="uip-date-range" readonly>\
      <span @click="showPicker()" class="material-icons-outlined  uk-text-muted" style="margin-left:5px;">expand_more</span>\
    </div>',
});
  ...
  template:
    ...
    <div class="">\
        ...
        <template v-for="module in modules" >\
          <div v-if="isInSearch(module, searchString)" class="uk-width-1-2">\
